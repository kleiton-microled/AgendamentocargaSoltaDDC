...
Public Class CadastrarMotoristas
    ...
    Private Function Validar() As Boolean
        ...
        Dim nome As String() = txtNome.Text.Split(" ")

        If nome(0).Length < 3 Then
            lblMsgErro.Text = "O primeiro nome do motorista tem que ter mais de três caracteres"
            PanelMsg.Visible = True
            Return False
        End If

        If txtNome.Text.Length < 3 Then
            lblMsgErro.Text = "O nome do motorista tem que ter mais de três caracteres"
            PanelMsg.Visible = True
            Return False
        End If

        If nome.Count = 1 Then
            lblMsgErro.Text = "Preencha o nome do motorista corretamente com nome e sobrenome"
            PanelMsg.Visible = True
            Return False
        End If
