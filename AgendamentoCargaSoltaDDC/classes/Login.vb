Public Class Login
    ...
    Public Function Acesso(ByVal ID As String) As Object
        ...
        Dt = Banco.Consultar("SELECT * FROM INTERNET.TB_INT_ACESSO WHERE TIAID=" & ID & "")
        ...
        If dt.rows.count > 0 Then
            ...
            Dt = Banco.Consultar("SELECT AUTONUM,RAZAO,CGC FROM OPERADOR.TB_CAD_TRANSPORTADORAS WHERE CGC='" & TransportadoraOBJ.CNPJ & "'")
